...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asciistuff-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14152&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asciistuff-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asciistuff` can be installed with:

```
conda install asciistuff
```

It is possible to list all of the versions of `asciistuff` available on your platform with:
